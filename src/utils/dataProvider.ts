...
export const dataProvider = {
  create: async <TResult, TEntity extends object>(
    resource: string,
    body: TEntity,
    ...
    return authFetch(
      `${api}/${resource}${queryString ? (resource.includes("?") ? `&${queryString}` : `?${queryString}`) : ""}`,
      {
        method: "POST",
  ...
  get: async <TResult, K extends object>(
    resource: string,
    identifier?: string,
  ...
  getList: async <TResult extends object, K extends object>(
    resource: string,
  ...
  update: async <TResult, TEntity extends object>(
    resource: string,
    identifier: string,
    ...
    return authFetch(
      `${api}/${postApi}${queryString ? (postApi.includes("?") ? `&${queryString}` : `?${queryString}`) : ""}`,
      {
        method: "PUT",
        body: JSON.stringify(body),
      }
